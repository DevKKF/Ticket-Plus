...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activer pour trier les colonnes par ordre croissant",sSortDescending:": activer pour trier les colonnes par ordre décroissant"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},
sEmptyTable:"Aucune donnée disponible",sInfo:"Affichage _START_ de _END_ à _TOTAL_ entrées",sInfoEmpty:"Affichage 0 à 0 sur 0 entries",sInfoFiltered:"(filtrer from _MAX_ total entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouvés"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
