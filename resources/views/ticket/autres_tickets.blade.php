...
<div class="page-bar">
   <ul class="page-breadcrumb">
      ...
      <li>
         <a href="#">Liste des autres tickets</a>
      </li>
   </ul>
</div>
<div class="row">
      ...
      <div class="portlet box tiketplus">
         ...
         <div class="portlet-body">
            <div class="table-toolbar">
               <div class="row">
                  <form action="{{ route('autres_tickets') }}" method="GET">
                     <div class="col-md-2">
                     ...
                     <div class="col-md-2" style="margin-top: 25px;">
                        ...
                        <a href="{{ route('autres_tickets') }}" class="btn btn-success" style="float:right"><i class="fa fa-refresh"></i></a>
                     </div>
                  </form>
               </div>
               <hr>
