   ...
   <div class="col-md-12 col-sm-12">
      <div class="portlet box tiketplus">
         <div class="portlet-title">
            <div class="caption">
               <i class="icon-drawer font-20"></i>Liste des tickets PM
            </div>
            <div class="actions">
         ...
         <div class="portlet-body">
            <div class="table-toolbar">
               <div class="row">
                  <form action="{{ route('ticket_pm') }}" method="GET">
                     <div class="col-md-2">
                     ...
                     <div class="col-md-2" style="margin-top: 25px;">
                        ...
                        <a href="{{ route('ticket_pm') }}" class="btn btn-success" style="float:right"><i class="fa fa-refresh"></i></a>
                     </div>
                  </form>
               </div>
               <hr>
